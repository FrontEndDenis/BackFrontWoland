    ...
    for i in range(len(data_format)):
        ...
        if data_format[i][COLUMN_IMAGE_1_TECH_NAME]:
            ...
            if not (tmp_import_image in list_import_image):
                ...
                import_image(None, data_format[i][COLUMN_IMAGE_1_TECH_NAME], data_format[i][COLUMN_IMAGE_1_HTTP], info, product.id)
        ...
        if data_format[i][COLUMN_IMAGE_2_TECH_NAME]:
            ...
            if not (tmp_import_image in list_import_image):
                ...
                import_image(None, data_format[i][COLUMN_IMAGE_2_TECH_NAME], data_format[i][COLUMN_IMAGE_2_HTTP], info, product.id)
                list_import_image.append(tmp_import_image)
