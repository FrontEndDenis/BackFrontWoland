...
class Filials(models.Model):
	...
	full_name_req = models.CharField(max_length=256, verbose_name="Полное наименование предприятия", blank=True,
									 null=True)
	short_name_req = models.CharField(max_length=256, verbose_name="Краткое наименование предприятия", blank=True,
									  null=True)
	...
	director_req = models.CharField(max_length=100, verbose_name="Директор (на основании устава)", blank=True,
									null=True)
	...
	is_base = models.BooleanField(verbose_name="Основные филиалы, отображаются сверху при выборе города", blank=True,
								  default=False)
